...
$(function () {
    ...
    $("#container img.").load(removeLoadingAnimation);
    ...
    function loadWork() {
        ...
        for (var i = 0; i <= array.length - 1; i++) {
            ...
            array[i].insertBefore(preloadImage(list[i]), array[i].getElementsByClassName("mask")[0]);
            // array[i].querySelect()
        }
    ...
    function displayWork(start, howmany) {
        ...
        $("#show").fadeIn('400', function() {
            ...
            for (var i = 0; i <= howmany; i++) {
                var image = preloadImage(resource[start + i]);
                document.getElementById("displayer").appendChild(image);
            }
