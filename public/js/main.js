$(function(){var d=this,a=false;$("#button-menu").bind("click",e);$("#module li p").hover(function(){$(this).siblings(".ani").stop().animate({opacity:1},300,"swing");
...
$("#page, #aside, #button-menu, #show").stop().animate({left:"+="+h+"px"},400,"easeOutSine");$("#button-menu").addClass("is-active");}else{a=false;$("#page").unbind("click",e);
$("#page, #aside, #button-menu, #show").stop().animate({left:"-="+h+"px"},300,"easeInSine");$("#button-menu").removeClass("is-active");}f.stopPropagation();
function g(){$("#button-menu div").eq(0).addClass("rotate-1");$("#button-menu div").eq(1).addClass("rotate-2");$("#button-menu div").eq(2).addClass("rotate-3");
